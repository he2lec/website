...
const Button = styled("button")`
  ${tw`bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center text-black cursor-pointer transition-all transition-100 transition-linear`};
  & > * {
    ${tw`text-black`}
  }
  &:hover > *,
...
const AbsoluteLink = styled("span")`
  ${tw`absolute top-0 w-32 text-center font-normal border transition-all transition-100 transition-linear rounded`}
  & > * {
